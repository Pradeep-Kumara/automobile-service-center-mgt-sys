        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-20">
                    <div class="card-body">
                        <form action="{{ route('serviceHistory') }}" method="get">
                            {{ csrf_field() }}
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <label for="customer" class="col-sm-4 col-form-label">NIC</label>
                                                <div class="col-sm-8">
                                                    {{-- <input type="date" class="form-control" id="toDate" > --}}
                                                    <select class="form-control select2 tab" name="customer"  id="customer" onChange="viewCustomerName(this.value)">
                                                        <option value="" disabled selected>Select Customer </option>
                                                        @if(isset($customers))
                                                            @foreach($customers as $customer)
                                                                <option value="{{"$customer->customer_id"}}">{{$customer->customer_nic}} <p> - </p>{{$customer->customer_firstname}} </option>
                                                            @endforeach
                                                        @endif  
                                                    </select>
                                                </div>
                                        ...
                                        @if (count($joblist) != 0)  
                                            @foreach ($joblist as $job)
                                                <tr>
                                                    ...
                                                    {{-- <td>{{ $job->customerRelation->customer_firstname}} </td> --}}
...
<script type="text/javascript">
    ...
    function viewCustomerName(customerID){ 
            ...
            $.post('seviceHostory_viewCustomerName', {
                    customerID:customerID
                },function(data){
                
                $("#name").val(data.customer_lastname);

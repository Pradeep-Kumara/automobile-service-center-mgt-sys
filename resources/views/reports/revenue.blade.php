        ...
        <div class="container-fluid">
            ...
            <div class="col-lg-12">
                ...
                <div class="card m-b-20">
                    <div class="card-body">
                        <form action="{{ route('jobEfficiency') }}" method="get">
                            {{ csrf_field() }}
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered data-table"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Job Date</th>
                                            <th>Job Cost</th>
                                            <th>Job Revenue (LKR)</th>
                                            <th>Net Income (LKR)</th>                                           
                                    ...
                                    <tbody>
                                        ...
                                        @if (count($jobTaskList) != 0)  
                                            @foreach ($jobTaskList as $job)
                                                <tr>
                                                    <td>{{ $job->jobcard_id }}</td>
                                                    <td>{{ $job->jobcard_date }}</td>
                                                    <td>{{ $job->job_task_cost}}</td>
                                                    <td>{{ $job->job_task_price}}</td>  

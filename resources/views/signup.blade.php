            ...
            <div class="col-lg-8">
                ...
                <div class="card m-b-20">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <img src="assets/images/img_register.jpg"  height="100%" width="100%">
                            </div>
                            <div class="col-lg-6">
                                <form class="" method="post" enctype="multipart/form-data" action="{{ route('saveUser') }}" id="saveUserId">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <label for="pass">NIC<span style="color: red"> *</span></label>

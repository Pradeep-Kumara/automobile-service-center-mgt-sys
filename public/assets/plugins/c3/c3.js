(function (window) {
        ...
        if ($$.transiting) {
            interval = window.setInterval(function () {
                if (!$$.transiting) {
                    ...
                    if ($$.legend.selectAll('.c3-legend-product-focused').size() > 0) {
                        $$.expandArc(targetIds);
                    }
                }
            }, 10);
    ...
    var CLASS = c3_chart_internal_fn.CLASS = {
        ...
        legendItem: 'c3-legend-product',
        legendItemEvent: 'c3-legend-product-event',
        legendItemTile: 'c3-legend-product-tile',
        legendItemHidden: 'c3-legend-product-hidden',
        legendItemFocused: 'c3-legend-product-focused',
